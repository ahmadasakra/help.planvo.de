...
**Karten-Ansicht:**
- Große Projekt-Karten mit Vorschaubild
- Schnell-Statistiken
- Status-Badge
...
- 👤 **Meine Projekte**: Nur zugewiesene Projekte
- 📅 **Zeitraum**: Diese Woche, Dieser Monat
- 🏷️ **Tags**: Kategorien, Kunden, Priorität
...
**Pflichtfelder:**
- 📝 **Projektname** (z.B. "Büroumbau Hamburg")
...
**Aufgaben-Details:**
- 📝 **Titel** (Was ist zu tun?)
- 📄 **Beschreibung** (Detaillierte Anweisungen)
- 👤 **Zuständig** (Wer macht es?)
- 📅 **Fälligkeitsdatum**
- ⚡ **Priorität** (Niedrig, Mittel, Hoch, Kritisch)
- 🏷️ **Labels** (z.B. "Frontend", "Backend", "Design")
- ⏱️ **Geschätzter Aufwand** (in Stunden)
...
**Drag & Drop:**
- Ziehen Sie Aufgaben zwischen Spalten
...
**Aufgaben-Kommentare:**
- Diskussionen zu spezifischen Aufgaben
- Statusupdates
- Fragen klären
...
[:octicons-arrow-right-24: Weiter zu Schichtplanung](schichten.md){ .md-button .md-button--primary }
